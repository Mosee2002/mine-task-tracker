...
# ---- CHAT ROOM ----
    ...
    if require(role, "analytics.view"):
        ...
        analytics_sub = option_menu(
            menu_title=None,
            options=["Overview", "Reliability", "Backlog & Compliance", "Failure Pareto", "Cost", "Safety"],
            icons=["grid-1x2-fill", "speedometer2", "list-check", "bar-chart-fill", "cash-coin", "shield-fill-check"],
            orientation="horizontal", default_index=0, styles=menu_styles(),
        )
