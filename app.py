...
TRANSLATIONS = {
    "en": {
        ...
        "nav.JSA Library": "JSA Library", "nav.Job Plans": "Job Plans", "nav.Locations": "Locations", "nav.Motor Rewinds": "Motor Rewinds",
    ...
    "fr": {
        ...
        "nav.JSA Library": "Bibliothèque JSA", "nav.Job Plans": "Plans de travail", "nav.Locations": "Emplacements", "nav.Motor Rewinds": "Rebobinages de moteurs",
    ...
    "es": {
        ...
        "nav.JSA Library": "Biblioteca JSA", "nav.Job Plans": "Planes de trabajo", "nav.Locations": "Ubicaciones", "nav.Motor Rewinds": "Rebobinados de motores",
    ...
    "pt": {
        ...
        "nav.JSA Library": "Biblioteca JSA", "nav.Job Plans": "Planos de Trabalho", "nav.Locations": "Localizações", "nav.Motor Rewinds": "Rebobinagens de Motores",
    ...
    "zh": {
        ...
        "nav.JSA Library": "JSA库", "nav.Job Plans": "工作计划", "nav.Locations": "位置", "nav.Motor Rewinds": "电机重绕",
    ...
    "hi": {
        ...
        "nav.JSA Library": "जेएसए लाइब्रेरी", "nav.Job Plans": "जॉब प्लान", "nav.Locations": "स्थान", "nav.Motor Rewinds": "मोटर रिवाइंडिंग",
...
nav_icons = ["list-task", "bar-chart-fill", "truck", "hdd-stack-fill", "shield-lock-fill", "box-seam-fill",
             ...
             "diagram-3-fill", "geo-alt-fill", "kanban-fill"]
            ...
            if st.form_submit_button("🔧 Start Rewind"):
                if not _mr_tag.strip():
                    ...
                    if create_motor_rewind(_mr_tag.strip(), _mr_desc.strip() or None, full_name, asset_id=_mr_asset_id):
                        ...
                        st.error("Failed to start rewind.")
