...
# AI-assisted features share this one config. Supports either
# provider, not just one, matching what the feature brief allowed
# ("OpenAI/Claude") — whichever key is actually configured is used,
# checked at call time in generate_smart_text() below.
ANTHROPIC_API_KEY = _secret_get("ANTHROPIC_API_KEY", "")
OPENAI_API_KEY = _secret_get("OPENAI_API_KEY", "")
AI_FEATURES_AVAILABLE = bool(ANTHROPIC_API_KEY or OPENAI_API_KEY)
...
.main-header {
    ...
    top: 60px;  /* clears Streamlit's own native header — see comment above */
...
TRANSLATIONS = {
    "en": {
        ...
        "nav.JSA Library": "JSA Library", "nav.Job Plans": "Job Plans", "nav.Locations": "Locations", "nav.Motor Rewinds": "Motor Rewinds", "nav.Instrument Calibration": "Instrument Calibration", "nav.Outage Commander": "Outage Commander", "nav.Transformer Health": "Transformer Health", "nav.Fault Recorder": "Fault Recorder",
    ...
    "fr": {
        ...
        "nav.JSA Library": "Bibliothèque JSA", "nav.Job Plans": "Plans de travail", "nav.Locations": "Emplacements", "nav.Motor Rewinds": "Rebobinages de moteurs", "nav.Instrument Calibration": "Étalonnage des instruments", "nav.Outage Commander": "Commandant de panne", "nav.Transformer Health": "Santé du transformateur", "nav.Fault Recorder": "Enregistreur de défauts",
    ...
    "es": {
        ...
        "nav.JSA Library": "Biblioteca JSA", "nav.Job Plans": "Planes de trabajo", "nav.Locations": "Ubicaciones", "nav.Motor Rewinds": "Rebobinados de motores", "nav.Instrument Calibration": "Calibración de instrumentos", "nav.Outage Commander": "Comandante de apagón", "nav.Transformer Health": "Salud del transformador", "nav.Fault Recorder": "Registrador de fallas",
    ...
    "zh": {
        ...
        "nav.JSA Library": "JSA库", "nav.Job Plans": "工作计划", "nav.Locations": "位置", "nav.Motor Rewinds": "电机重绕", "nav.Instrument Calibration": "仪表校准", "nav.Outage Commander": "停电指挥", "nav.Transformer Health": "变压器健康", "nav.Fault Recorder": "故障记录仪",
    ...
    "hi": {
        ...
        "nav.JSA Library": "जेएसए लाइब्रेरी", "nav.Job Plans": "जॉब प्लान", "nav.Locations": "स्थान", "nav.Motor Rewinds": "मोटर रिवाइंडिंग", "nav.Instrument Calibration": "उपकरण अंशांकन", "nav.Outage Commander": "आउटेज कमांडर", "nav.Transformer Health": "ट्रांसफार्मर स्वास्थ्य", "nav.Fault Recorder": "फॉल्ट रिकॉर्डर",
...
def render_logo_bar():
    ...
    Scrolls normally with the rest of the page — an earlier version
    made this fixed to the viewport alongside the header, but stacking
    the logo, poster slideshow, and ticker all permanently on screen
    at once consumed close to 460px on mobile and read as visually
    overwhelming in practice. Only the header stays fixed now.
    """
...
nav_options = ["Task Dashboard", "Production", "Haulage", "Assets", "Permits", "Inventory", "Incidents",
               ...
               "Motor Rewinds", "Instrument Calibration", "Outage Commander", "Transformer Health",
               "Fault Recorder"]
nav_icons = ["list-task", "bar-chart-fill", "truck", "hdd-stack-fill", "shield-lock-fill", "box-seam-fill",
             ...
             "diagram-3-fill", "geo-alt-fill", "kanban-fill", "speedometer2", "cone-striped", "lightning-charge-fill",
             "activity"]
